"""
Django settings for resilient_af_40310 project.
...
ROOT_URLCONF = 'resilient_af_40310.urls'
...
WSGI_APPLICATION = 'resilient_af_40310.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "resilient_af_40310 API",
    "DESCRIPTION": "API documentation for resilient_af_40310 App",
    "VERSION": "v1",
}
